package com.kododake.hellbrowser.ui
...
import com.kododake.hellbrowser.settings.SettingsCallbacks
import com.kododake.hellbrowser.settings.SettingsViews
import com.kododake.hellbrowser.startpage.StartPageManager
import com.kododake.hellbrowser.tabs.TabManager
import com.kododake.hellbrowser.web.updatePageDarkening
...
class OverlayManager(
    ...
    fun showCheckLatestView() {
        ...
        binding.checkLatestInstalledVersion.text = activity.getString(
            ...
            "v${com.kododake.hellbrowser.BuildConfig.VERSION_NAME}"
        )
    ...
    private fun fetchLatestVersion() {
        Thread {
            try {
                val url = java.net.URL("https://api.github.com/repos/kododake/HellBrowser/releases/latest")
                ...
                if (conn.responseCode == 200) {
                    ...
                    activity.runOnUiThread {
                        ...
                        val currentVer = com.kododake.hellbrowser.BuildConfig.VERSION_NAME.trim().removePrefix("v")
