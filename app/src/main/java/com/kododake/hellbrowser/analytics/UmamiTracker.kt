package com.kododake.hellbrowser.analytics
...
class UmamiTracker(context: Context) {
    ...
    private val appVersion: String by lazy {
        com.kododake.hellbrowser.BuildConfig.VERSION_NAME
    }
    ...
    fun trackEvent(eventName: String, eventData: Map<String, String>? = null) {
        val payload = buildJsonObject {
            ...
            put("payload", buildJsonObject {
                ...
                put("hostname", "hellbrowser.internal")
                put("name", eventName)
    ...
    private companion object {
        ...
        private const val USER_AGENT = "Mozilla/5.0 (Android) HellBrowser"
    }
}