package com.kododake.hellbrowser.settings
...
import com.kododake.hellbrowser.model.AppThemeMode
import com.kododake.hellbrowser.model.QuickActionButtonMode
import com.kododake.hellbrowser.model.QuickActionButtonPosition
...
object SettingsViews {
    fun createSettingsContent(
        ...
        sponsorsQrImage.setImageBitmap(com.kododake.hellbrowser.ui.QRUtils.generateQrCode(sponsorUrl, dp(100)))
        ...
        clearSitePermissionsButton.setOnClickListener {
            showConfirmationDialog(
                ...
                com.kododake.hellbrowser.web.SslErrorHandlerHelper.clearAllowedSslHosts()
                showSuccessDialog(
