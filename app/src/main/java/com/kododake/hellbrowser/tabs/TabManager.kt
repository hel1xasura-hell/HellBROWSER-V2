package com.kododake.hellbrowser.tabs
...
import com.kododake.hellbrowser.R
...
import com.kododake.hellbrowser.ui.adapters.TabAdapter
import com.kododake.hellbrowser.web.BrowserCallbacks
import com.kododake.hellbrowser.web.configureWebView
...
data class BrowserTab(
    ...
    val speechBridge: com.kododake.hellbrowser.web.SpeechRecognitionBridge,
...
class TabManager(
    ...
    fun createBrowserTab(initialUrl: String?, initialTitle: String = "", activate: Boolean): BrowserTab? {
        ...
        val speechBridge = com.kododake.hellbrowser.web.SpeechRecognitionBridge(tabView) { pageUrl ->
    ...
    private fun setupWebMessageListener(webView: android.webkit.WebView, speechBridge: com.kododake.hellbrowser.web.SpeechRecognitionBridge) {
        if (WebViewFeature.isFeatureSupported(WebViewFeature.WEB_MESSAGE_LISTENER)) {
            WebViewCompat.addWebMessageListener(webView, com.kododake.hellbrowser.web.SpeechRecognitionBridge.BRIDGE_OBJECT_NAME, setOf("*")) { webViewInstance, message, sourceOrigin, isMainFrame, _ ->
