package com.kododake.hellbrowser
...
import com.kododake.hellbrowser.AppConstants.FREE_DROID_WARN_SOLUTIONS_URL
import com.kododake.hellbrowser.AppConstants.FREE_DROID_WARN_VERSION_KEY
import com.kododake.hellbrowser.AppConstants.GITHUB_REPO_URL
import com.kododake.hellbrowser.AppConstants.KEEP_ANDROID_OPEN_URL
import com.kododake.hellbrowser.AppConstants.MENU_BUTTON_AUTO_HIDE_DELAY_MS
import com.kododake.hellbrowser.AppConstants.MENU_BUTTON_SHOW_DELAY_MS
import com.kododake.hellbrowser.AppConstants.REQUEST_CODE_POST_NOTIFICATIONS
import com.kododake.hellbrowser.AppConstants.REQUEST_CODE_RECORD_AUDIO
import com.kododake.hellbrowser.analytics.UmamiTracker
import com.kododake.hellbrowser.bookmarks.BookmarkManager
import com.kododake.hellbrowser.data.BrowserPreferences
import com.kododake.hellbrowser.data.SiteIconCache
import com.kododake.hellbrowser.databinding.ActivityMainBinding
import com.kododake.hellbrowser.model.QuickActionButtonMode
import com.kododake.hellbrowser.model.UserAgentProfile
import com.kododake.hellbrowser.navigation.NavigationManager
import com.kododake.hellbrowser.permissions.PermissionManager
import com.kododake.hellbrowser.startpage.StartPageManager
import com.kododake.hellbrowser.tabs.BrowserTab
import com.kododake.hellbrowser.tabs.TabManager
import com.kododake.hellbrowser.ui.BrowserUIManager
import com.kododake.hellbrowser.ui.MainActivitySetup
import com.kododake.hellbrowser.ui.OverlayManager
import com.kododake.hellbrowser.ui.ThemeManager
import com.kododake.hellbrowser.web.BrowserCallbacks
import com.kododake.hellbrowser.web.releaseCompletely
import com.kododake.hellbrowser.web.updateDesktopMode
import com.kododake.hellbrowser.web.updateUserAgentProfile
import org.woheller69.freeDroidWarn.R as FreeDroidWarnR

/**
 * MainActivity serves as the central hub for the HellBrowser application.
...
class MainActivity : AppCompatActivity() {
    ...
    var latestReleaseUrl: String = "https://github.com/kododake/HellBrowser/releases"
        private set
